$(document).ready(function () {
    ...
    let modal = $("#AddDivisionModal");
    let form = $("#kt_modal_add_division_form");
    let submitButton = $("[data-kt-divisions-modal-action='submit']");
    ...
    // Close Modal
    $("[data-kt-divisions-modal-action='close']").on("click", function () {
        resetForm();
        modal.modal("hide");
    });

    // Discard (Reset Form & Close Modal)
    $("[data-kt-divisions-modal-action='cancel']").on("click", function () {
        resetForm();
        modal.modal("hide");
    });
    ...
    submitButton.on("click", function (e) {
        ...
        $.ajax({
            url: '/Divisions/Create', // Update with your endpoint
            type: "Post",
            datatype: "json",
            data: formData,
            contentType: false,
