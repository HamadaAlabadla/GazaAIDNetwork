...
$(document).ready(function () {
     datatable =  table.DataTable({
        ...
        "serverSide": true,
         "filter": true,
        "ajax": {
            "url": "/OrderAid/GeAllOrdersAid",
            "type": "post",
            "datatype": "json",
            "data": function (d) {
                d.id = projectId; // Assign the projectId dynamically
        ...
        "columns": [
            ...
            },
            {
                ...
                "render": function (data, type, row) {
                    var button = ``;
                    if (row.orderAidStatus === "توجه للإستلام") {
                        button = `<button onclick="Confirm('${data}')" class="text-danger border-0 bg-transparent">
